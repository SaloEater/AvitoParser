...
namespace ToastNotifications
{
    public partial class Notification : Form
    {
        ...
        public Notification(string title, string body, int duration, FormAnimator.AnimationMethod animation, FormAnimator.AnimationDirection direction, String URL)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (url != "error")System.Diagnostics.Process.Start("Chrome.exe", url);
